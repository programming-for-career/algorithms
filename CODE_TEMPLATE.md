# Code Template for Algorithms

## File Structure
- Each algorithm should be placed in its respective folder based on the programming language.
- Example: `C/LinearSearch.c`, `Python/LinearSearch.py`, etc.

## Code Guidelines:
1. **Function Names:** Use meaningful and descriptive names for functions. 
   - Example: `linear_search` or `bubble_sort`.

2. **Variable Names:** Use descriptive names for variables.
   - Example: `arr[]`, `n`, `x` (for an array, size of array, and the element to search).

3. **Comments:**
   - Include a comment block at the beginning of the file that describes the algorithm and its complexity.
   - Add inline comments explaining the logic, especially for complex steps.

4. **Indentation:** Use 4 spaces for indentation.

5. **Consistency:** Maintain consistency in formatting, function signatures, and overall code style.
